...
summary(movies) # it looked too good so I checked ..
```
...
```{r}
longest <- movies_imputed %>% slice_max(runtime, n=10, with_ties = FALSE)
shortest <- movies_imputed %>% slice_min(runtime,n=10, with_ties = FALSE)
longest
shortest
```
