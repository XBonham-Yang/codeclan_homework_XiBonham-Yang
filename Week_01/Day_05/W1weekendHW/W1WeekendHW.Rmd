...
and replace them with the mean? I will find the shorest book.
```{r}
NA_books <- books %>% 
...
#Well, I don't think it's correct.... But I don't know how to get ready
...
add up the mean oof all the col
bigger one win.
```{r}
eng_spa_books <- books %>% 
