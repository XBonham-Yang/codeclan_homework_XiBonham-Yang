...
predict_log <- tibble(tenure = seq(1, 72, 1)) %>%
              add_predictions(mod_t, type = 'response')

ggplot(telco_clean) +
  geom_jitter(aes(x = tenure, y = churn), shape = 1,
...
$$
ln(odds_{success}(x)) = -0.039 \times x + 0.037
$$

higher tenure number has a lower chance of churn 
